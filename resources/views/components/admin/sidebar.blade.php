      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="{{ route("admin.dashboard") }}" class="text-nowrap logo-img">
            <img src="{{ asset("Logo hitam.png") }}" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.siswa.aktif") ? "active" : "" }}" href="{{ route("admin.siswa.aktif") }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.siswa.pkl") ? "active" : "" }}" href="{{ route("admin.siswa.pkl") }}" aria-expanded="false">
                <span>
<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-user-share"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h3" /><path d="M16 22l5 -5" /><path d="M21 21.5v-4.5h-4.5" /></svg>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.perusahaan.terkonfirmasi") ? "active" : "" }}" href="{{ route("admin.perusahaan.terkonfirmasi") }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.perusahaan.belum.terkonfirmasi") ? "active" : "" }}" href="{{ route("admin.perusahaan.belum.terkonfirmasi") }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.ajuan") ? "active" : "" }}" href="{{ route("admin.ajuan") }}" aria-expanded="false">
                <span>
            ...
            <li class="nav-small-cap">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs("admin.daftar.admin") ? "active" : "" }}" href="{{ route("admin.daftar.admin") }}" aria-expanded="false">
                    <span>
                ...
                <li class="sidebar-item">
                <a class="sidebar-link {{ request()->routeIs("admin.tambah.admin") ? "active" : "" }}" href="{{ route("admin.tambah.admin") }}" aria-expanded="false">
                    <span>
        ...
        @endif
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->routeIs("admin.kritik.saran") ? "active" : "" }}" href="{{ route("admin.kritik.saran") }}" aria-expanded="false">
                <span>
